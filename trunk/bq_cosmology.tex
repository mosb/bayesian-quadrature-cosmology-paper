...
%\jmlrheading{1}{2011}{1-48}{4/00}{10/00}{Duvenaud, Nickisch and Rasmussen}

% Short headings should be running head and authors last names

\ShortHeadings{Bayesian Quadrature for Cosmology}{Duvenaud, Osborne and ...}
\firstpageno{1}

\begin{document}
\twocolumn[
\title{Bayesian Quadrature for Cosmology}

\author{\name David Duvenaud \email dkd23@cam.ac.uk \\
       \addr Department of Engineering\\
       Cambridge University\\
       \AND
       \name Michael Osborne \email mosb@robots.ox.uk \\
...
\begin{abstract}
Posterior inference in cosmology is typically solving approximately using some form of MCMC.  We introduce an alternative method for computing posterior quantities of interest, called Bayesian Quadrature.  This procedure constructs a model of the likelihood function being integrated, and provides posterior distributions over the model evidence as well as marginal distributions of unkown quantities.  Bayesian Quadrature can use active learning to choose sampled points, allowing it to be much more sample-efficient than MCMC methods.  We demonstrate the use of Bayesian Quadrature to compute model evidences and marginal distributions for hyopthesized planetary systems orbiting Gliese 581.
\end{abstract}

\begin{keywords}
 Bayesian Quadrature,  Gaussian processes
\end{keywords}
